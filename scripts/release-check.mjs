...
// Re-pinned once the v0.5.3 tag existed, in a commit of its own — the same order v0.5.1 used
...
const RELEASE_TAG = "v0.5.3";
const RELEASE_COMMIT = "45435cfcd51c4e26567e9dd7389e7f233ac2afe8";
