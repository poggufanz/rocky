...
// Re-pinned once the v0.7.5 tag existed, in a commit of its own — the same order v0.5.1 used
...
const RELEASE_TAG = "v0.7.5";
const RELEASE_COMMIT = "d6b21cf125c2cf7468ed64e851c7a0485d2becc7";
