...
// Re-pinned once the v0.7.4 tag existed, in a commit of its own — the same order v0.5.1 used
...
const RELEASE_TAG = "v0.7.4";
const RELEASE_COMMIT = "3054698e429b9a2cf51a81cfc91ce1e9ff974228";
