...
// Re-pinned once the v0.7.3 tag existed, in a commit of its own — the same order v0.5.1 used
...
const RELEASE_TAG = "v0.7.3";
const RELEASE_COMMIT = "4aa845279983ec7c7daaf869f6e0cdf370a6dc25";
