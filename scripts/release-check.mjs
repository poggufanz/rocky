...
// Re-pinned once the v0.5.5 tag existed, in a commit of its own — the same order v0.5.1 used
...
const RELEASE_TAG = "v0.5.5";
const RELEASE_COMMIT = "f20b293edcdeb92dbeac37e2fe42579e2b2c5c10";
