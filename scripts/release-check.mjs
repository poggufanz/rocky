...
// Re-pinned once the v0.7.6 tag existed, in a commit of its own — the same order v0.5.1 used
...
const RELEASE_TAG = "v0.7.6";
const RELEASE_COMMIT = "e6d425486ea5dde57493fc78c6d3af017a97ac1f";
